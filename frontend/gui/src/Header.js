                                        ...
                                        <form className="main-search search-form full-width">
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6 col-md-5">
                                                    <a href="#" className="delivery-add p-relative"> <span className="icon"><i className="fas fa-map-marker-alt"></i></span>
                                                                ...
                                                                <div className="row">
                                                                    <div className="col-lg-3 col-sm-6">
                                                                        <div className="menu-style">
                                                                            ...
                                                                            <ul>
                                                                                <li className="active"><a href="index-2.html" className="text-light-white fw-500">Landing Page</a>
                                                                                </li>
